...
conda activate bz-record-12-18
...
mkdir -p ~/path/to/envs/bz-record-19-21
tar xzvf speedrunner-19-21.tar.gz -C ~/path/to/envs/bz-record-19-21
~/path/to/envs/bz-record-19-21/bin/conda-unpack

## activate the environment
source ~/path/to/envs/bz-record-19-21/bin/activate
...
conda activate bz-record-19-21
```